    ...
    <>
      <ContentBox variant={ContentBoxVariant.Light} id="about">
        <ContentBoxHeading>
          ...
          <BelowTitleText>
            I&apos;M A PASSIONATE SOFTWARE DEVELOPER FOCUSED ON MAKING A
            POSITIVE IMPACT THROUGH IMPROVING ACCESSIBILITY AND EFFICIENCY. I
            BELIEVE THAT CARING FOR OTHERS AND PUTTING PASSION INTO YOUR WORK
